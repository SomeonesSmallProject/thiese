...
def download_pdb(pdb_ID, output_dir):
    subprocess.run(["/home/lzg/transformer/Download_PDB", pdb_ID, output_dir])
...
if __name__ == "__main__":
    print("Start")
    pwd = os.getcwd()
    data_csv_file_path = "/home/lzg/CASF-2016/power_screening/CoreSet.dat"
    csv_df = pd.read_csv(data_csv_file_path, sep="   ")
    df = csv_df[["#code", " logKa"]]
    df = df.rename(columns={" logKa": "logKa"})
    mol_files_meta_folder = "/home/lzg/CASF-2016/coreset"
    output_folder = "/home/lzg/transformer/output"
    Export_df_list = []
